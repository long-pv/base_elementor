...
function crb_load_localization() {
	...
	if ( is_admin()
		...
		if ( $locale == 'en_US' ) {
			...
			add_filter( 'load_textdomain_mofile', function ( $mofile, $domain ) {
				...
				$new_mofile = dirname( $mofile ) . '/' . $domain . '-' . $locale . '.mo';
	...
	// It's optional if translations are located in the global WP_LANG_DIR . '/plugins/' folder
	// and it's a fallback if no translations in that folder.
